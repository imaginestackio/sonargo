...
![](https://sonarcloud.io/api/project_badges/measure?project=imaginekube_sonargo&metric=alert_status)  ![](https://goreportcard.com/badge/github.com/magicsong/sonargo)
[![GoDoc](https://godoc.org/github.com/magicsong/sonargo/sonar?status.svg)](https://godoc.org/github.com/imaginekube/sonargo/sonar)
...
```go
import github.com/imaginekube/sonargo/sonar
```
...
- Sonarqube community does not build a v7.4 docker image for public, so a v7.4 dockerfile is provided in [build](https://github.com/imaginekube/sonargo/tree/master/build) folder. 
...
## Author
 ...
 (ImagineKube, cto@imaginekube.com.com)
